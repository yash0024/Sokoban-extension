...
def test_manhattan_fun():
    ...
    # Correct Manhattan distances for the initial states of the example puzzles
    ...
    print("*************************************")
    print("You calculated the correct Manhattan distance for {} states out of 22.".format(
        solved))
...
def test_alternate_fun():
 ...
 #       se.trace_on(2)
    ...
    print("\n*************************************")
    print("Of {} initial puzzles, {} were solved in less than {} seconds by this solver.".format(len(PROBLEMS), solved,
                                                                                                  timebound))
    print("Puzzles that remain unsolved in the set are: {}".format(unsolved))
    print("The manhattan distance implementation solved {} out of {} example puzzles given {} seconds.".format(
        benchmark1, len(PROBLEMS), timebound))
    print("The better implementation solved {} out of {} example puzzles given {} seconds.".format(benchmark2,
                                                                                                     len(PROBLEMS),
                                                                                                     timebound))
    print("*************************************\n")
    ##############################################################
...
def test_fval_function_fun():
    ...
    print("\n*************************************")
    print("fval_function calculated the correct fval for {} out of {} tests.".format(solved1, len(correct_fvals1)))
    print("*************************************\n")
...
def test_iterative_gbfs_fun():
    ...
    print("Of {} initial puzzles, {} were solved in less than {} seconds by this solver.".format(len(PROBLEMS), solved,
                                                                                                  timebound))
    print("Of the {} puzzles that were solved, the cost of {} matched or outperformed the benchmark.".format(solved,
                                                                                                              benchmark))
    print("Puzzles that remain unsolved in the set are: {}".format(unsolved))
    print("The manhattan distance implementation solved 9 out of the 22 example puzzles given 2 seconds.")
    print("The better implementation solved 16 out of the 22 example puzzles given 2 seconds.")
    print("*************************************\n")
...
def test_iterative_astar_fun():
    ...
    print("Of the {} puzzles that were solved, the cost of {} matched or outperformed the benchmark.".format(solved,
                                                                                                              benchmark))
    print("Problems that remain unsolved in the set are: {}".format(unsolved))
    print("The manhattan distance implementation solved 9 out of the 22 example puzzles given 2 seconds.")
    print("The better implementation solved 13 out of the 22 example puzzles given 2 seconds.")
    print("*************************************\n")
    ##############################################################
...
def test_weighted_astar_fun():
    ...
    for j in range(0, 5):  # tiny problems only!
        ...
        for weight in weights:
            final, stats = weighted_astar(m, heur_fn=heur_alternate, weight=weight,
